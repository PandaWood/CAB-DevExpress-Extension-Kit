...
namespace CABDevExpress.UIElements
{
    ...
    /// </summary>
    public class SkinRibbonGalleryUIAdapter : UIElementAdapter<GalleryItemGroup>
	{
		private readonly SkinRibbonGalleryBarItem ribbonGallery;
		...
		public SkinRibbonGalleryUIAdapter(SkinRibbonGalleryBarItem ribbonGallery, WorkItem workItem)
		{
			Guard.ArgumentNotNull(ribbonGallery, "SkinRibbonGalleryBarItem");
